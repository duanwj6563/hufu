...
public class ExcelWriteUtil{
    public final static String NO_DEFINE = "no_define";//未定义的字段
    public final static String DEFAULT_DATE_PATTERN="yyyy年MM月dd日";//默认日期格式
    public final static int DEFAULT_COLOUMN_WIDTH = 17;
    ...
    public static void exportExcel(String title, Map<String, String> headMap, JSONArray jsonArray, String datePattern, int colWidth, OutputStream out) {
        ...
        si.setAuthor("sunlands");  //填加xls文件作者信息
        si.setApplicationName("导出程序"); //填加xls文件创建程序信息
        si.setLastAuthor("最后保存者信息"); //填加xls文件最后保存者信息
        si.setComments("sunlands is a programmer!"); //填加xls文件作者信息
        si.setTitle("数据信息"); //填加xls文件标题信息
        si.setSubject("数据信息");//填加文件主题信息
    ...
    public static void downloadExcelFile(String title,Map<String,String> headMap,JSONArray ja,HttpServletResponse response){
        try {
            ...
            ExcelWriteUtil.exportExcelX(title,headMap,ja,null,0,os);
    ...
    public static void main(String[] args) throws IOException {
        ...
        outXls.close();
        OutputStream outXlsx = new FileOutputStream("D:\\test\\3.xlsx");
